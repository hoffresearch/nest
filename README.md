...
- `AGENTS.md` for the operating contract for ai agents and contributors; the single agent instruction source, route claude, gemini, codex and similar tools here on init (no per-tool instruction files)
