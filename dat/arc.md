...
this file is the human readable companion to dat/arc.yaml. it records what each requested path does and how it fits into the repo.
...
- dat | local notes dir | low-friction architecture notes and machine-readable repo maps.
- data | data dir | lfs corpus, demo datasets, and measured preset outputs.
- doc | documentation dir | architecture, usage, changelog, and supporting image asset.
...
- dat/arc.md | markdown note | human-readable architecture and inventory document, rewritten in this pass.
- data | data dir | top-level home for the demo sources, baseline corpus, and measure outputs.
- doc/architecture.md | markdown doc | practical binary format and runtime contract reference for the repo.
...
- data/demo/README.md | markdown doc | explains the seven PT-BR datasets, dedupe process, and reproducible corpus build inputs.
